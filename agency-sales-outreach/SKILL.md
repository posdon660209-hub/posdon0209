...
Body structure (under 150 words):
  ...
  Line 1 ??RELEVANCE (why them, why now)
    "I noticed [specific trigger / company news / role change] ??    [one sentence connecting it to a relevant pain point]."
...
Breakup email template:
  ...
  "[First name], I've reached out a few times and haven't heard back ??  which usually means one of two things: the timing isn't right, or
