...
## 5. Solution Overview
[Narrative description of the proposed solution ??2?? paragraphs]
...
**Rationale**: [2?? sentences on why this recommendation, what evidence drives it, and what would change the decision]
...
| 60 days | Support tickets on related topic | ??0% | CS |
...
- **Cycle time**: Discovery-to-shipped in under 8 weeks for medium-complexity features (2?? engineer-weeks)
