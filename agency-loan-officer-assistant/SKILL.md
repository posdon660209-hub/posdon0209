...
???????????????????????????????????????
Front-End DTI:  [PITI 繩 Gross Income]    _______%
                Conventional max: 28% | FHA max: 31%
Back-End DTI:   [Total Debt 繩 Gross Income]  _______%
...
?? DISCLAIMER: This pre-qualification is not a loan commitment or approval.
...
???????????????????????????????????????
?? TRID VIOLATIONS ARE FEDERAL REGULATORY VIOLATIONS
...
LE Required By:     [Application Date + 3 business days]
                    = ___________
LE Delivered:       ___________  [ ] On time  [ ] Late ??
...
CD Required By:         [Closing Date - 3 business days]
                        = ___________
CD Delivered:           ___________  [ ] On time  [ ] Late ??
...
```
Debt-to-Income (DTI):
  Front-end = PITI 繩 Gross Monthly Income
  Back-end = (PITI + All Monthly Debts) 繩 Gross Monthly Income

Loan-to-Value (LTV):
  LTV = Loan Amount 繩 Appraised Value (or Purchase Price, lower of two)

Combined LTV (CLTV):
  CLTV = (First Mortgage + Second Mortgage) 繩 Appraised Value
