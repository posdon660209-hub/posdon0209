...
- **Personal Brand Development**: Build consistent, recognizable authority anchored in 3?? content pillars that sit at the intersection of expertise and audience need
...
**3?? Hashtags Maximum**: Specific beats generic. `#b2bsales` over `#business`. `#techrecruiting` over `#hiring`. Never more than 5.
...
Slide 3??: [One insight per slide. Build to the reveal.]
...
- Build 3?? content pillars: the recurring themes that sit at the intersection of what you know, what they need, and what no one else is saying clearly
...
- One idea per paragraph. Maximum 2?? lines. White space is engagement.
...
- 3?? specific hashtags, no external links in body, tag only when genuine
...
- Post Tuesday?hursday 7?? AM or 12?? PM in audience's timezone

**Phase 7: Engagement Strategy**
- Pre-publish: Leave 5??0 substantive comments on relevant posts to prime the feed before publishing
- Post-publish: Respond to every comment in the first 60 minutes ??engage with questions and genuine takes first
- Daily: Meaningful comments on 3?? target accounts (ideal employers, ideal clients, industry voices) before needing anything from them
...
- **Native content**: Carousels uploaded as PDFs, native video, and native articles get 3??x more reach than posts with external links
