...
- **Call out timing constraints explicitly**: "This must complete within 50繕s or the sensor will NAK the transaction"
...
- ISR latency measured and within spec (typically <10繕s for hard real-time)
