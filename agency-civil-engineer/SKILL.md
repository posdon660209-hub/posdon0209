...
- **Eurocode suite** (EN 1990??999) with country-specific National Annexes:
...
- **USA**:
  ...
  - ASCE 7 ??Minimum design loads (Chapters 2??1: gravity, wind, seismic, snow)
...
Mu = wu繚L簡/8 = 64.2 ? 6.1簡 / 8 = 298 kN繚m

Section properties (W18x35): Zx = 642,000 mm糧, Iy = 11.1?10??mm???Mn = ?繚Fy繚Zx = 0.9 ? 345 ? 642,000 = 199 kN繚m  ??INADEQUATE
??Upsize to W21x44: Zx = 948,000 mm糧
?Mn = 0.9 ? 345 ? 948,000 = 294 kN繚m  ??Check
298 > 294 kN繚m  ??Still insufficient ??W21x48: ?Mn = 325 kN繚m ??
Deflection (SLS): 帤LL = 5wLL繚L??/ (384繚E繚Ix)
W21x48: Ix = 193?10??mm??帤LL = 5 ? (29.2/1000) ? 6100??/ (384 ? 200,000 ? 193?10?? = 18.1 mm
Limit: L/360 = 6100/360 = 16.9 mm  ??EXCEEDS LIMIT
??W24x55 (Ix = 277?10??mm??: 帤LL = 12.6 mm < 16.9 mm ??
...
Design moment: MEd = 280 kN繚m (ULS, EN 1990 LC: 1.35G + 1.5Q)

fcd = 帢cc繚fck/帠c = 0.85 ? 30 / 1.5 = 17.0 MPa
fyd = fyk/帠s = 500 / 1.15 = 435 MPa

K = MEd / (b繚d簡繚fcd) = 280?10??/ (300 ? 550簡 ? 17.0) = 0.102
...
As,req = MEd / (fyd繚z) = 280?10??/ (435 ? 480) = 1,341 mm簡

Provide: 3H25 (As = 1,473 mm簡) ??Check minimum: As,min = 0.26繚fctm/fyk繚b繚d = 0.26?2.9/500?300?550 = 249 mm簡 ??
Shear: VEd = 180 kN
vEd = VEd / (b繚z) = 180,000 / (300 ? 480) = 1.25 MPa
...
Soil: c' = 10 kPa, ?' = 28簞, 帠 = 19 kN/m糧

Terzaghi factors (?' = 28簞): Nc = 25.8, Nq = 14.7, N帠 = 16.7
qu = c'繚Nc + q繚Nq + 0.5繚帠繚B繚N帠
...
Rd/Ad ??1.0 using characteristic values and partial factors 帠? = 1.25, 帠c = 1.25
