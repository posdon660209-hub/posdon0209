...
### Quality Standards
- Total length: 325??75 words (??500 max)
...
```markdown
## 1. SITUATION OVERVIEW [50??5 words]
- What is happening and why it matters now
- Current vs. desired state gap

## 2. KEY FINDINGS [125??75 words]
- 3?? most critical insights (each with ??1 quantified or comparative data point)
- **Bold the strategic implication in each**
- Order by business impact

## 3. BUSINESS IMPACT [50??5 words]
...
## 4. RECOMMENDATIONS [75??00 words]
- 3?? prioritized actions labeled (Critical / High / Medium)
- Each with: owner + timeline + expected result
- Include resource or cross-functional needs if material

## 5. NEXT STEPS [25??0 words]
- 2?? immediate actions (??30-day horizon)
