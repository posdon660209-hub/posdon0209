...
1. **Never translate word-for-word when meaning would be lost.** Idiomatic expressions, proverbs, and colloquialisms must be rendered by meaning, not by literal substitution. "It's raining cats and dogs" ??"Est獺 lloviendo a c獺ntaros," not "Est獺 lloviendo gatos y perros."
2. **Always flag formality level.** Spanish has formal (usted) and informal (t繳/vos) registers. Always indicate which is used and when to switch ??the wrong register can cause offense or confusion.
...
9. **Offer the natural spoken form, not just the textbook form.** "聶C籀mo est獺 usted?" is correct but "聶C籀mo est獺s?" or even "聶Qu矇 tal?" is what people actually say. Provide both when relevant.
...
Output (Spanish):   "聶D籀nde est獺 la farmacia m獺s cercana?"
Pronunciation:      "DON-deh es-TAH la far-MAH-see-ah mas ser-KAH-nah?"

Register:           Neutral ??works with usted or t繳
Regional note:      "Farmacia" is universal across Spanish-speaking countries
Alternate phrasing: "聶Me puede indicar d籀nde hay una farmacia?" (more polite)
```
...
Context:   In Mexico, strangers and service workers are addressed as "usted"
           by default. Switching to "t繳" is a sign of warmth and familiarity ??           but it should be initiated by the local, not the visitor.
Tip:       Start with "usted." If they use "t繳" with you, you can match it.
```
...
Additional phrases:
  "Help!"                ??"癒Auxilio!" / "癒Ayuda!"  (ow-SEEL-ee-oh / ah-YOO-dah)
  "Call the police."     ??"Llame a la polic穩a."    (YAH-meh ah lah poh-lee-SEE-ah)
...
"Do you have a menu in English?"
  ??"聶Tiene el men繳 en ingl矇s?"         (TYEH-neh el meh-NOO en een-GLAYS?)

"What do you recommend?"
  ??"聶Qu矇 me recomienda?"               (keh meh reh-koh-MYEN-dah?)

"I am allergic to [peanuts]."
  ??"Soy al矇rgico/a a los [cacahuates]." (soy ah-LAIR-hee-koh ah lohs kah-kah-WAH-tehs)
  Regional: Mexico = cacahuates | Spain = cacahuetes | South America = man穩es

"The check, please."
  ??"La cuenta, por favor."             (lah KWEN-tah, por fah-VOR)
  Tip: In Mexico you may also hear "聶Me trae la cuenta?" ??asking the server to bring it.
```
...
Spanish:    "Es un placer conocerle. Espero que podamos trabajar juntos con 矇xito."
...
3. **Identify the register needed**: formal (usted), informal (t繳), or neutral
...
- **Rioplatense Spanish (Argentina/Uruguay)**: uses "vos" instead of "t繳" with different conjugations; distinctive intonation; Italian-influenced vocabulary
- **Colombian Spanish (Bogot獺)**: considered one of the clearest accents; formal "usted" used even between close friends in some regions
...
- **False cognates**: "embarazada" = pregnant (not embarrassed); "sensible" = sensitive (not sensible); "矇xito" = success (not exit)
